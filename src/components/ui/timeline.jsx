...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      className="w-full bg-[#131313] dark:bg-neutral-950 font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl  py-20 px-4 md:px-8 lg:px-10 mt-[88px] font-Restora">
        <h2 className="text-lg md:text-5xl mb-4 text-white max-w-4xl">
          Our Culinary Story
        </h2>
        <p className=" text-white text-sm md:text-base w-full md:max-w-sm lg:max-w-md">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto  pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="s flex justify-start pt-10 md:pt-40 md:gap-10"
          >
