...
function PerfectPlaceSection() {
  return (
    <section className="grid grid-cols-3 gap-8">
      ...
      <div>
        <p className="font-Restora text-secondary font-normal text-base">
        ...
        <p className="font-Restora text-secondary font-normal text-base mt-8">
        ...
        <button className="font-Restora text-secondary font-normal text-sm bg-primary w-[244px] h-[62px] uppercase  mt-8">
          View menu
        </button>
      </div>
    </section>
